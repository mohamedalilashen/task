            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                      <ul class="navbar-nav ms-auto py-4 py-lg-0">
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="{{ asset('home') }}">Home</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="{{ asset('contant') }}">Contact</a></li>
                    </ul>
                </div>
            </div>
        </nav>
                    ...
                    <div class="col-md-10 col-lg-8 col-xl-7">
                     ...
                     @else
                           @foreach ($data as $datas)
                                <span class="subheading" style="color:red;">your name is {{ $datas['name'] }}</span>
                                <br>
                                  <span class="subheading" style="color:red;">your email is {{ $datas['email'] }}</span>
                            @endforeach
                     @endif
